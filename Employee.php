...
<?php include 'header.php';?>
        ...
        <section>
        <!-- Gives an overview of all employees -->
         <?php 
           ...
           while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
           	echo "<tr><td>" . $row['EmployeeID'] . "</td><td>" . $row['PostNr'] . "</td><td>" . $row['Firstname'] . "</td><td>" . $row['Surname'] . "</td><td>" . $row['Salary'] . "</td>
		          <td>" . $row['Position'] . "</td><td>" . $row['Email'] . "</td></tr>";
           }
            echo "</table>";
           ?>
        </section>
